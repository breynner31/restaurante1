        ...
        <div class="menu-bar">
            <div class="menu">
                ...
                <ul class="menu-links">
                    ...
                    <li class="nav-link">
                        <a href="../plato_2/lista.php">
                            <i class="fa-solid fa-utensils"></i>
                            <span class="text nav-text">Lista  de restaurante</span>
                        </a>
                    </li>

                    <li class="nav-link">
                        <a href="../plato_2/lista_plato.php">
                            <i class="fa-solid fa-utensils"></i>
                            <span class="text nav-text">Lista  de platos</span>
                        </a>
                    </li>
                    ...
                    <li class="nav-link">
                        <a href="registro_plato.php">
                            <i class="fa-solid fa-xmark"></i>
                            <span class="text nav-text">Registrar  Platos</span>
                        </a>
                    </li>
