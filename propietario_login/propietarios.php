...
<button  class="button1" ><a href="../tiendas/php/propi.php" >Panel de propietarios</a> </button>
</form>

<button  class="button1" ><a href="../index.php" >Panel de control</a> </button>
</div>
